...
<div class="container">
    <div class="card-body">
        <form method="POST" action="/admin/update-product/{{$selectedProduct->prodid}}" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-group row">
                ...
                <div class="col-md-10">
                    <input id="name" type="text" class="form-control @error('name') is-invalid @enderror" name="name" value="{{ $selectedProduct->name}}" required autocomplete="name" autofocus>
            ...
            <div class="form-group row">
                ...
                <div class="col-md-10">
                    <textarea id="description" class="form-control @error('description') is-invalid @enderror" name="description" required autocomplete="description" autofocus>{{ $selectedProduct->description}}</textarea>
            ...
            <div class="form-group row">
                ...
                <div class="col-md-10">
                    <input id="price" type="text" class="form-control @error('price') is-invalid @enderror" name="price" value="{{ $selectedProduct->price}}" required autocomplete="price" autofocus>
